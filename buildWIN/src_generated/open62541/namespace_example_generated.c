...
bool dummy = (
!(retVal = function_namespace_example_generated_0_begin(server, ns))
&& !(retVal = function_namespace_example_generated_1_begin(server, ns))
&& !(retVal = function_namespace_example_generated_2_begin(server, ns))
&& !(retVal = function_namespace_example_generated_3_begin(server, ns))
&& !(retVal = function_namespace_example_generated_4_begin(server, ns))
&& !(retVal = function_namespace_example_generated_4_finish(server, ns))
&& !(retVal = function_namespace_example_generated_3_finish(server, ns))
&& !(retVal = function_namespace_example_generated_2_finish(server, ns))
&& !(retVal = function_namespace_example_generated_1_finish(server, ns))
&& !(retVal = function_namespace_example_generated_0_finish(server, ns))
); (void)(dummy);
return retVal;
}
