...
#ifndef NAMESPACE_PLC_GENERATED_H_
#define NAMESPACE_PLC_GENERATED_H_
...
extern UA_StatusCode namespace_plc_generated(UA_Server *server);

_UA_END_DECLS

#endif /* NAMESPACE_PLC_GENERATED_H_ */
