...
#ifndef NAMESPACE_INSTANCE_GENERATED_H_
#define NAMESPACE_INSTANCE_GENERATED_H_
...
extern UA_StatusCode namespace_instance_generated(UA_Server *server);

_UA_END_DECLS

#endif /* NAMESPACE_INSTANCE_GENERATED_H_ */
